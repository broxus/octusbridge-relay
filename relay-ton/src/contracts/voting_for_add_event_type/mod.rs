...
impl VotingForAddEventType {
    ...
    pub async fn get_details(
        &self,
        addr: MsgAddrStd,
    ) -> ContractResult<VotingForAddEventTypeDetails> {
...
impl Contract for VotingForAddEventType {
    #[inline]
...
const ABI: &str = include_str!("../../../abi/VotingForAddEventType.abi.json");

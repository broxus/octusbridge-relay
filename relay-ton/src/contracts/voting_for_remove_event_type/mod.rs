...
impl VotingForRemoveEventType {
    ...
    pub async fn get_details(
        &self,
        addr: MsgAddrStd,
    ) -> ContractResult<VotingForRemoveEventTypeDetails> {
...
impl Contract for VotingForRemoveEventType {
    #[inline]
...
const ABI: &str = include_str!("../../../abi/VotingForRemoveEventType.abi.json");

...
impl EthEventsHandler {
    ...
    pub fn get_metrics(&self) -> EthEventsHandlerMetrics {
        let successful_vote_count = self
            .state
            .transport
            .get_successful_vote_count(self.state.configuration_id);

        EthEventsHandlerMetrics {

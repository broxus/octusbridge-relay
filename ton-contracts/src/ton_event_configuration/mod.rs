    ...
    impl TonEventConfigurationAbi {
        pub fn basic_configuration() -> &'static ton_abi::Function {
            ...
            FUNCTION.get_or_init(|| {
                ...
                let output = vec![Param {
                    name: "basicConfiguration".to_string(),
        ...
        pub fn get_details() -> &'static ton_abi::Function {
            ...
            FUNCTION.get_or_init(|| {
                ...
                let output = vec![
                    Param {
                        name: "_basicConfiguration".to_string(),
                        kind: ParamType::Tuple(vec![
                            Param {
                                name: "eventABI".to_string(),
                                kind: ParamType::Bytes,
                    ...
                    Param {
                        name: "_networkConfiguration".to_string(),
                        kind: ParamType::Tuple(vec![
                            Param {
                                name: "eventEmitter".to_string(),
                                kind: ParamType::Address,
        ...
        pub fn network_configuration() -> &'static ton_abi::Function {
            ...
            FUNCTION.get_or_init(|| {
                ...
                let output = vec![Param {
                    name: "networkConfiguration".to_string(),
                    kind: ParamType::Tuple(vec![
                        Param {
                            name: "eventEmitter".to_string(),
                            kind: ParamType::Address,
